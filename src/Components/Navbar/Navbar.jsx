    ...
    <div className=" md:w-9/12 lg:w-9/12 mx-auto mt-6">
      <div className="navbar ">
          ...
          <NavLink to="/" className="  ">
            <div className="flex items-center">
              <img
                ...
                alt=""
              />
              <p className="text-4xl font-medium font-bebas text-white">
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1  text-[14px] font-normal uppercase font-roboto gap-5 text-black md:text-white lg:text-white ">
            {nav}
          </ul>
        </div>
